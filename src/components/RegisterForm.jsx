export const RegisterForm = () => {
  ...
  return (
    <div id="register" className="w-full pt-20 pb-12 text-center">
      <h2 className="font-main text-th_green text-3xl md:text-4xl pb-3">
        Register Now
      </h2>
      <p className="font-sub text-base lg:text-xl text-th_green pb-5 ">
        1, 2, and 3 Bedroom Residences - Coming Soon
      </p>

      <form
        id="spark-registration-form"
        className="pt-0 md:pt-8 w-10/12 md:w-7/12 lg:w-10/12 xl:w-8/12 mx-auto grid grid-cols-1 lg:grid-cols-3 items-end gap-4 xl:gap-10 text-center text-th_green font-sub placeholder-th_green"
      ...
      >
        ...
        <select
          ...
          required
        >
          <option value="">What type of home are you interested in?*</option>
        ...
        >
          ...
          <option value="$1,000,000 - $1,100,000">$1,000,000 - $1,100,000</option>
          <option value="$1,100,000 - $1,200,000">$1,100,000 - $1,200,000</option>
        ...
        >
          ...
          <option value="Solterra Social Media">Solterra Social Media</option>
          ...
          <option value="Radio: 93.1FM - RED FM">Radio: 93.1FM - RED FM</option>
        ...
        <div className="col-start-1 col-span-1 lg:col-span-3 text-start">
          ...
          <p className="text-xs pt-3 leading-4">
            ...
            &quot;Solterra&quot; to contact me with information about this and
            other communities that may be of interest. I understand this may
            take the form of communication via email, telephone or post and
            consent to the collection, use and disclosure of the information
            submitted for the purposes disclosed on this page. If I want to
            receive email communication, I must give explicit consent via the
            tick box located above. I may withdraw my consent at any time.
          </p>
        </div>
        <button
          name="button"
