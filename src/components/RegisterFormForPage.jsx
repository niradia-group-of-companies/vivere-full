export const RegisterFormForPage = () => {
  ...
  return (
    <div className='w-full h-full mx-auto relative -mt-20 top-1/2 left-1/2 -translate-x-1/2 text-center'>
      ...
      <div id="register" className="w-full h-full pt-5 pb-0 lg:py-20 text-center bg-th_ivory">
      <img src='/img/register.png' alt="register" className='mx-auto object-contain w-auto mb-8 lg:mb-14' />
