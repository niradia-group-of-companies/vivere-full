...
export const HomeSectionThree = () => {
  return (
    ...
    >
      <div
        className="home-section-three-left flex-1  basis-1/3 flex flex-col justify-center items-center 
      xl:pt-64 xl:pb-20"
      >
      ...
      <div className="home-section-three-right flex-1 basis-2/3 w-full"></div>
    </div>
  );
};
